export default function SvgSprite() {
  return (
    <svg style={{ display: "none" }}>
      ...
      <symbol id="rating" viewBox="0 0 34 32">
        <path
          strokeLinejoin="miter"
          strokeLinecap="butt"
          strokeMiterlimit="4"
          strokeWidth="2.56"
          d="M20.906 10.021c0.34 0.643 0.958 1.093 1.675 1.217l8.106 1.4-5.733 5.904c-0.507 0.522-0.743 1.249-0.64 1.969l1.171 8.144-7.383-3.629-0.25-0.106c-0.508-0.18-1.063-0.18-1.571 0l-0.25 0.106-7.385 3.629 1.173-8.144c0.104-0.72-0.133-1.447-0.64-1.969l-5.735-5.904 8.108-1.4c0.717-0.124 1.335-0.573 1.675-1.217l3.84-7.277 3.84 7.277z"
        ></path>
      </symbol>
